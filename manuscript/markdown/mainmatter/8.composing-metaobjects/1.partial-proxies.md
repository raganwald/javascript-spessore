...
[^basic_encapsulate]: We will deliberately leave out some refinements such as [private methods](#privacy) to highlight the ideas we're exploring here.
...
![IsSelfDescribing stacked on HasName and HasCareer](images/8/stacking.png)
