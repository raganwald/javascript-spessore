...
We could get around this with [a pattern that has the shared prototype mix behaviour into singleton prototypes](#mix-into-singleton). But let's look at another mechanism.